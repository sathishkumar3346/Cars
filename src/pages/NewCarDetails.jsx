      ...
      <div className="max-w-6xl w-full mx-auto py-6">
        ...
        <div className="flex flex-col md:flex-row gap-16 mt-4">
          ...
          <div className="text-sm w-full md:w-1/2 text-white border p-2">
            ...
            <div className="mt-6">
              <p className="text-white line-through">MRP: ₹{car.price + 50}</p>
              <p className="text-2xl font-medium">MRP ₹{car.price}</p>
            ...
            <p className="text- font-medium mt-2">Description: {car.description}</p>


            <div className="flex items-center mt-4 gap-4 text-base">
              <button className="w-full py-3.5 cursor-pointer font-medium bg-gray-100 text-gray-800/80 hover:bg-gray-200 transition " onClick={TestDrive}>
                Make a Test Drive
              </button>
              <button
                className="w-full py-3.5 cursor-pointer font-medium bg-cyan-500 text-white hover:bg-indigo-600 transition"
                onClick={() =>
                  navigate("/payment", {
                    state: { car },
                  })
