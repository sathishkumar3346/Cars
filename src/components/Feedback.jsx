const Feedback = () => {
    ...
    const CreateCard = ({ card }) => (
        ...
        <div className="w-full">
            <div className="rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 bg-gray-800 p-4">
                ...
                <p className="text-sm py-4 text-white">Radiant made undercutting all of our competitors an absolute
                    breeze.</p>
